...
if __name__ == "__main__":
    ...
    sfc_connection.add_sf("SF1", "127.0.0.1", "10001", "image_crop", "SFF1")
    sfc_connection.add_sf("SF2", "127.0.0.1", "10002", "gray_scale", "SFF1")
    sfc_connection.add_sf("SF3", "127.0.0.1", "10003", "face_detect", "SFF1")
    sfc_connection.add_sf("SF4", "127.0.0.1", "10004", "eye_detect", "SFF1")
